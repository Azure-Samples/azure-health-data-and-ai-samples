...
resource kv 'Microsoft.KeyVault/vaults@2025-05-01' = if (idpProvider != 'EntraID') {
  name: vaultName
  location: location
  properties: {
    tenantId: tenantId
...
resource writerRoleAssignments 'Microsoft.Authorization/roleAssignments@2022-04-01' = [for writerId in writerObjectIds: if (idpProvider != 'EntraID') {
...
resource readerRoleAssignments 'Microsoft.Authorization/roleAssignments@2022-04-01' = [for readerId in readerObjectIds: if (idpProvider != 'EntraID'){
