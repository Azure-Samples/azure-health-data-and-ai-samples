...
namespace SMARTCustomOperations.AzureAuth.Filters
{
    public sealed class ServiceBaseOutputFilter : IOutputFilter
    {
        ...
        private readonly IBundleGeneratorService _bundleGeneratorService;

        public ServiceBaseOutputFilter(ILogger<ServiceBaseOutputFilter> logger,
            AzureAuthOperationsConfig configuration, IBundleGeneratorService bundleGeneratorService) 
        {
            _logger = logger;
        ...
        public async Task<OperationContext> ExecuteAsync(OperationContext context)
        {
            ...
            ServiceBaseObject.Bundle bundleObj = await _bundleGeneratorService.CreateBundle();
