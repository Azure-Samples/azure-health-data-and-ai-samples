...
{
    /// <summary>
    /// Augments the IDP's token response with SMART-specific fields that the IDP
    /// does not include natively: patient, fhirUser, launch context, need_patient_banner, etc.
    /// No scope translation is performed — external IDPs return SMART scopes as-is.
    /// </summary>
    public sealed class TokenOutputFilter : IOutputFilter
    {
        ...
        public TokenOutputFilter(ILogger<TokenOutputFilter> logger, AzureAuthOperationsConfig configuration, ContextCacheService? cacheService = null)
        {
            _logger = logger;
...
#pragma warning restore CS0067
        ...
        public async Task<OperationContext> ExecuteAsync(OperationContext context)
        {
            ...
            try
            {
                tokenResponse = new(context.ContentString, _configuration.UserIdClaimType);
