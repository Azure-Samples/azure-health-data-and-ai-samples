...
namespace SMARTCustomOperations.AzureAuth.Filters
{
    public sealed class TokenInputFilter : IInputFilter
    {
        ...
        public TokenInputFilter(ILogger<TokenInputFilter> logger, AzureAuthOperationsConfig configuration, IAuthProvider authProvider, IAsymmetricAuthorizationService asymmetricAuthorizationService, IClientConfigService clientConfigService)
        {
            _logger = logger;
