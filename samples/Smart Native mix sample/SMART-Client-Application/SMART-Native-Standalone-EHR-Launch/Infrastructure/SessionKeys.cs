...
public static class SessionKeys
{
    ...
    /// <summary>ID token from the lightweight User Context OIDC login.
    /// Preferred for context-cache calls in Entra because aud maps to the context app client id.</summary>
    public const string UserContextIdToken = "smart.usercontext.id_token";
