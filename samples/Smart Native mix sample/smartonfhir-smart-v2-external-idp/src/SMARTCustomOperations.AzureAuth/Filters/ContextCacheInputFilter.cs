...
namespace SMARTCustomOperations.AzureAuth.Filters
{
    ...
    public sealed class ContextCacheInputFilter : IInputFilter
    {
        ...
        public ContextCacheInputFilter(ILogger<ContextCacheInputFilter> logger, AzureAuthOperationsConfig configuration, ContextCacheService? cacheService = null)
        {
            _logger = logger;
        ...
        public async Task<OperationContext> ExecuteAsync(OperationContext context)
        {
            ...
            string userIdClaimType = _configuration.UserIdClaimType;
