...
/// <summary>
/// Builds a JWT client assertion for SMART v2 Backend Services <c>private_key_jwt</c> (ES384 / P-384).
/// </summary>
public static class SmartBackendJwtAssertion
{
    public const string ClientAssertionType =
        "urn:ietf:params:oauth:client-assertion-type:jwt-bearer";

    /// <param name="signingKey">ECDSA P-384 private key.</param>
    /// <param name="keyId">Must match the Key ID (kid) registered with the IdP for this client.</param>
